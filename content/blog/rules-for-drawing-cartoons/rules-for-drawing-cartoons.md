...
A good friend and I were chatting about his job. He was talking about how they
...
compared it to the design rules for cartoons. And it got me thinking.

![](./screen-shot-2024-01-24-at-2.46.38-pm.png)

Each cartoon has their own style. It's necessary to establish the brand and for
differentiation. Rules communicate to viewers what to expect. And when you break
the rules—its for effect. T﻿hough there are some rules that you don't break.

![](./screen-shot-2024-01-24-at-2.47.23-pm.png)

![](./screen-shot-2024-01-24-at-2.48.21-pm.png)

In addition to some of the simpler and strict rules like those above. There are
...
![](./screen-shot-2024-01-24-at-2.50.18-pm.png)

These artifacts are written down guidelines to make sure everyone is on the same
...
the end of the day we do all need to work together towards a single destination.

![](./screen-shot-2024-01-24-at-2.50.37-pm.png)

My good friend then asked me:

> W﻿hat are the rules for your company?

I honestly had nothing that I could reasonably point to as an answer for him. As
...
compiler accepts it, it works!" is the bar, even if that bar is incredibly low.

We have to do better. On my very last project I started to do just that. I used
...
wiki and shared it with the wider dev team.

I received amazing positive feedback on what I was writing up from several
people. This is definitely a practice I am going to repeat in the future.
